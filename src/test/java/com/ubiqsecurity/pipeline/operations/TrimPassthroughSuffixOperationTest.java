...
public class TrimPassthroughSuffixOperationTest {
  ...
  public void simple_NoPassthroughRules_ReturnsCurrentValue() {
    try {
      ...
      Operation op = new TrimPassthroughSuffixOperation();
  ...
  @Test
  public void simple_SuffixLengthZero_ReturnsCurrentValue()  throws Exception {
    OperationContext context = setup();
  ...
  @Test
  public void simple_SuffixLengthGreaterThanCurrentValueLength_ThrowsException() throws Exception {
    OperationContext context = setup();
  ...
  @Test
  public void simple_SuffixLengthEqualToCurrentValueLength_ReturnsEmptyString()  throws Exception {
    OperationContext context = setup();
    ...
    assertEquals(context.getData().get("Suffix"), "abc123");
  }

  @Test
  public void simple_SuffixLengthThree_ReturnsTrimmedValue()  throws Exception {
    OperationContext context = setup();
    ...
    assertEquals(op.Invoke(context), "ab");
    assertEquals(context.getData().get("Suffix"), "c123");
  }
